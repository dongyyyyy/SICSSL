...
def get_cifar10(args, root):
    ...
    target_dist = l_samples / np.array(l_samples).sum()
    return train_labeled_dataset, train_unlabeled_dataset, test_dataset, ir2, target_dist, l_samples, u_samples
...
def get_cifar10_contrastive(args, root):
    ...
    ir2=l_samples[-1]/np.array(l_samples)
    target_dist = l_samples / np.array(l_samples).sum()
    return train_labeled_dataset, train_unlabeled_dataset, test_dataset, ir2, target_dist
